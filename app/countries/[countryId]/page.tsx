...
const CountryDetail = async ({ params }: { params: { countryId: string } }) => {
  ...
  return (
    <div className="h-full w-full flex items-center justify-center">
      <div className=" w-11/12 h-full rounded-lg flex flex-col pb-2">
        <div className="w-full h-[70%] flex justify-around p-10">
          <div className="w-1/2 h-full flex items-center justify-center p-16 overflow-hidden">
            <img
              src={country.img}
              alt="flag"
          ...
          <div className="flex flex-col grow items-center justify-center">
            ...
            <Link
              href={"/countries"}
              className="rounded-md z-10 w-30 h-10 text-center flex items-center p-5 mt-3 bg-primary text-neutral-200 shadow-md shadow-slate-900"
            >
              <span className="flex">
                <ArrowLeftCircle />
                Back
        ...
        <div className="grow z-10">
          ...
          [&>ul>li]:bg-primary [&>ul>li]:w-[300px] [&>ul>li]:h-auto [&>ul>li]:rounded-lg [&>ul>li]:mb-2 [&>ul>li]:shadow-md [&>ul>li]:shadow-slate-900
          `}>
            <ul>
              <li>
                <label>Name:</label>
